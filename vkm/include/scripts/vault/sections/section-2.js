...
import { logout } from '../other/navbar.js';
...
function hostCreateGroup() {$('.host-popups').load('vkm/include/content/vault/group/create.html');}
function hostCreateKey() {$('.host-popups').load('vkm/include/content/vault/key/create.html');}
