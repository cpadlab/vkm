...
import { initializeViewKey } from './view.js';
import { initializeModKey } from './modify.js';
import { initializeDelKey } from './delete.js';
...
export function createKey(host, datakey, color) {
    ...
    dc_btn_view.addEventListener('click', function(event) {
        ...
        $('.host-popups').load('vkm/include/content/vault/key/view.html', function() {
    ...
    dc_btn_edit.addEventListener('click', function(event) {
        event.preventDefault();
        $('.host-popups').load('vkm/include/content/vault/key/modify.html', function() {
    ...
    dc_btn_delete.addEventListener('click', function(event) {
        event.preventDefault();
        $('.host-popups').load('vkm/include/content/vault/key/delete.html', function() {
