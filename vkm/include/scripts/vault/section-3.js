...
import { initializeModifyGroup } from './modify-group.js';
import { initializeDelGroup } from './delete-group.js';
    ...
    for (let option of datalist.options) {
        ...
        if (option.value != 'Favorites') {
            ...
            button.addEventListener('click', function(event) {
                ...
                $('.host-popups').load('vkm/include/content/vault/modify-group.html', function() {
            ...
            button2.addEventListener('click', function(event) {
                event.preventDefault();
                $('.host-popups').load('vkm/include/content/vault/delete-group.html', function() {
