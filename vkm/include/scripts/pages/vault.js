...
$('header').load('vkm/include/content/vault/other/navbar.html');
$('#section-2').load('vkm/include/content/vault/other/section-2.html'); 
$('#section-1').load('vkm/include/content/vault/other/section-1.html');
